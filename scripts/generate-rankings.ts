...
function generate(): void {
  ...
  const dbRows: Array<{ rankingType: string; priceBand: string | null; payload: unknown }> = [
    ...
    { rankingType: "quality-band-low", priceBand: "low", payload: r.byQualityPerBand.low },
    { rankingType: "quality-band-mid", priceBand: "mid", payload: r.byQualityPerBand.mid },
    { rankingType: "quality-band-high", priceBand: "high", payload: r.byQualityPerBand.high },
